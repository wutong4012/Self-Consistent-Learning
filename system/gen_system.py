...
class GenSystem(LightningModule):
    ...
    def set_gen_dataset(self):
        self.train_dataset, self.val_dataset = set_dataset(self.config, attri='gen')
    ...
    def predict_dataloader(self):
        ...
        return create_predict_dataloader(config=self.config, tokenizer=self.gen_tokenizer, attri='gen')
    ...
    def predict_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        output_dict = sample_sequence_batch(
            ...
            max_out_seq=100, end_token_id=50000, temperature=1.0, top_k=self.config.top_k, top_p=self.config.top_p,
        )
